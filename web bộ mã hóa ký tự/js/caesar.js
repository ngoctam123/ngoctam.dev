function btnEncryptCaeser() {
    document.getElementById("resultBruteforce").innerHTML = "";
    var plainText = document.getElementById("plainTextCaeser").value;
    ...
    document.getElementById("cipherTextCaeser").value = cipherText;
...
function btnDecryptCaeser() {
    document.getElementById("resultBruteforce").innerHTML = "";
    var cipherText = document.getElementById("cipherTextCaeser").value;
    ...
    if (key.length > 1) {
        ...
        document.getElementById("plainTextCaeser").value = "";
        ...
        document.getElementById("plainTextCaeser").value = plainText;
    }
